...
{GOOGLE}
{Mountainv View,California}
{\mydescription{Engineering Intern}{Improved internal, distributed, high QPS query engine. Implemented internal API for complex, ad-hoc queries. Implemetend query rewriter for increased compatibility. Interfaced with multiple distributed system frameworks. Explored back-end server design for serving terabytes of data efficiently.
}}
