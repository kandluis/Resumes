...
\mydescription{Expected Graduation}{May 2016} |
...
{\mydescription{Developer}{Implemented intelligent data exploration portal for Dataverse. Designed data exploration algorithms and visualization using Python (pandas) and Vincent/D3. Interfaced with Dataverse API for access to millions of datasets.  
}}
...
{Lead implementation of Python physics-based simulation based designed to explore decentralized algorithms for collective construction of complex structure. Interfaced with structural analysis program using PyWin32. Presented results to group of peers and professional researchers. 
}}
...
{Cambridge,Massachusetts}
{\mydescription{Teaching Fellow and Course Assistant}{Taught class of \~20 students to program in C, PHP,JavaScript and SQL. Introduced basic object-oriented concepts as well as memory management/hierarchy and good programming practices. Assisted in office hours for all course students (\~700). Graded problem sets and exams.}\\}
%------------------------------------------------
\entry
{August 2013--Present}
{HARVARD MATHEMATICS DEPARTMENT}
{Cambridge,Massachusetts}
{\mydescription{Course Assistant}{Taught classes of \~30 undergraduates covering introductory linear algebra and multi/single variable calculus. Maintained weekly office hours and problem-solving sessions. Graded assignments. Concepts included: differential equations and dynamical systems, linear transformations, vector spaces, and Fourier analysis.}}
