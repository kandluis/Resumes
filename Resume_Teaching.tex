...
{Cambridge, Massachusetts}
{\mydescription{Teaching Fellow - Data Structure and Algorithms}
...
{Cambridge,Massachusetts}
{\mydescription{Teaching Fellow - Intro. to Computer Science}{Taught class of \~20 students to program in C, PHP,JavaScript and SQL and introduced object-oriented concepts. Held office hours for all course students (\~700). Graded problem sets and exams.}}
...
{Cambridge,Massachusetts}
{\mydescription{Course Assistant - Linear Algebra and Calculus}{Taught classes of \~30 undergraduates covering introductory linear algebra and calculus. Maintained weekly office hours and problem-solving sessions. Graded assignments.}}
